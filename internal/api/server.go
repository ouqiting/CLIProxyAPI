...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.POST("/system/restart", s.mgmt.RestartSystem)
		...
		mgmt.PATCH("/api-key-models", s.mgmt.PatchAPIKeyModels)
		mgmt.DELETE("/api-key-models", s.mgmt.DeleteAPIKeyModels)
		...
		mgmt.GET("/webui-data", s.mgmt.GetWebUIData)
		mgmt.PUT("/webui-data", s.mgmt.PutWebUIData)
		mgmt.PATCH("/webui-data", s.mgmt.PutWebUIData)
		mgmt.DELETE("/webui-data", s.mgmt.DeleteWebUIData)
		...
		mgmt.PATCH("/openai-compatibility/status", s.mgmt.PatchOpenAICompatStatus)
